<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Data Siswa</h3>
    <div align="center">
        <img class="img-responsive" src='uploads/images/<?php echo $dataPegawai->foto; ?>' style="max-height:250px;">
    </div>
    ...
    <form method="POST" id="form-update-pegawai">
        ...
        <div class="input-group form-group">
          ...
          <input type="text" class="form-control" placeholder="ID" name="idPeserta" aria-describedby="sizing-addon2" value="<?php echo $dataPegawai->id; ?>">
        </div>
          <div class="input-group form-group">
          <span class="input-group-addon" id="sizing-addon2">
